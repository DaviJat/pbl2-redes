...
import json
import threading
from funcoes_servidor2 import *

SERVIDOR1 = (socket.gethostbyname(socket.gethostname()), 61582)
...
def retornar_distancia_servidor_1():
    return obter_distancias_de_outro_servidor(*SERVIDOR1)
...
def iniciar_servidor():
    ...
    print(f"servidores rodando em {SERVER_IP} na porta {SERVER_PORT}")
