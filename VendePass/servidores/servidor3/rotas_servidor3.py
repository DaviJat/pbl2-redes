...
import pickle
import os
from servidor3 import retornar_distancia_servidor_1, retornar_distancia_servidor_2
...
def criar_grafo():
    ...
    if distancias_servidor2:
        for (cidade1, cidade2), (distancia, tickets) in distancias_servidor2.items():
            if (cidade1, cidade2) not in grafo.edges:
                grafo.add_edge(cidade1, cidade2, weight=distancia, tickets=tickets)
